...
veriler=pd.read_csv("eksikveriler.csv") #aynı klasorde degilse dosya uzantısını ekle
print(veriler)
...
veriler=pd.read_csv("eksikveriler.csv") #aynı klasorde değilse dosya uzantısını ekle
print(veriler)
...
print(s2)#3 - Kategorik Verileri Sayısallaştırılmak
