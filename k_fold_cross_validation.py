...
# SVM destek vektör mak.
from sklearn.svm import SVC
classifier = SVC(kernel = 'rbf', random_state = 0)
classifier.fit(X_train, y_train)

# Tahminler
y_pred = classifier.predict(X_test) #aşağıda cross val yaptığımda bunu estimator olarak kullanacağım
...
print(basari.mean()) #algoritmanın başarı ortalaması
print(basari.std())
